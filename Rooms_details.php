...
*/
                        ...
                        <form action="pay_now.php" id="booking_form" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label mb-1">Number of Seats</label>
                                        <input name="seats" oninput="check_availability()" type="number" min="1" class="form-control shadow-none" placeholder="Enter number of seats" required>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function check_availability() {
            ...
            let seats_val = booking_form.elements['seats'].value;

            booking_form.elements['pay_now'].setAttribute('disabled', true);

            if (checkin_val !== '' && seats_val !== '') {
                ...
                xhr.onload = function() {
                    ...
                    if (data.status == 'check_in_earlier') {
                        pay_info.innerText = "Check-in date cannot be earlier than today";
                    } else {
                        pay_info.innerHTML = "Number of seats: " + data.seats + "<br>Total amount to pay: " + data.payment;
